...
export const PascualBetIcon = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => (
    <svg 
        ...
        <defs>
            <linearGradient id="pascual-icon-blue" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" stopColor="#0a2a8b" />
                <stop offset="100%" stopColor="#2c72ff" />
            </linearGradient>
            <linearGradient id="pascual-icon-red" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" stopColor="#b90000" />
                <stop offset="100%" stopColor="#ff2c2c" />
            </linearGradient>
             <linearGradient id="pascual-icon-gold" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" stopColor="#c5a242" />
                <stop offset="100%" stopColor="#f5e18c" />
            </linearGradient>
        </defs>
        <path fill="#021a6e" d="M50 0C25 25 0 50 0 75c0 25 25 25 50 25s50 0 50-25C100 50 75 25 50 0z" />
        <path fill="url(#pascual-icon-blue)" d="M50 0v125c25 0 50-25 50-50S75 25 50 0z" />
        <path fill="url(#pascual-icon-red)" d="M50 0C25 25 0 50 0 75c0 12.5 6.25 18.75 12.5 25C25 87.5 37.5 75 50 62.5V0z" />
