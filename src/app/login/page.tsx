...
const LuigiLogo = () => (
  <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M11 15.59V17l-1-1-3 3L8.41 19 12 15.41 15.59 19 17 17.59 13.41 14H12v-4H9v-2h5v6h1.59L19 14.59V12h-2v1.59l-3.59-3.59L12 11.41V6h-2v5.59L6.41 8 5 9.41l3 3V10H6v4h1.41L11 17.59z" fill="url(#grad)"/>
  </svg>
)
